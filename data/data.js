...
export const featureData = [
  {
    ...
    title: "Immigrant Integration Support",
    desc: "Helping Wolayta and other immigrants settle smoothly through community networking, cultural orientation, and solidarity.",
  },
  {
    icon: "iconoir-community",
    title: "Cultural Preservation & Connection",
    desc: "Promoting Wolayta heritage, traditions, and values while building strong diaspora bonds across generations and borders.",
  },
  {
    icon: "iconoir-peace-hand",
    title: "Humanitarian & Human Rights Action",
    desc: "Engaging in humanitarian efforts and standing for justice, dignity, and equality for communities at home and abroad.",
  },
  {
    icon: "iconoir-help-circle",
    title: "Community Empowerment & Self-Help",
    desc: "Creating strong neighborhood and diaspora networks that provide mutual assistance, advocacy, and opportunities for growth.",
  },
];
...
export const newsData = [
  {
    ...
    tag: "Community",
    date: "15th Sep 2025",
    title: "ወላይታ ድቻ ለኮፌዴሬሽን የመጀመርያ ዙር ማጣሪያ አል ኢትሃድን ዓርብ ይገጥማል::",
    excerpt: "",
    content: `ወላይታ ድቻ ለኮፌዴሬሽን የመጀመርያ ዙር ማጣሪያ አል ኢትሃድን ዓርብ ይገጥማል

 የኢትዮጵያ ጥሎ ማለፍ ዋንጫ 2017 ሻምፒዮና በመሆን ኢትዮጵያን ወክሎ ለኮፌዴሬሽን የመጀመርያ ዙር ማጣሪያ ጨዋታቸውን ከሊቢያው አል ኢትሃድ ጋር የተደለደለው የወላይታ ድቻ ቡድን የመጀመሪያ ዙር መጠሪያ ጨዋታ በአዲስ አበባው አበበ ቢቂላ ስታድየም አርብ መስከረም 9 ቀን ከቀኑ ዘጠኝ ሰዓት እንደሚያካሂድ የእግር ኳስ ዜና ምንጮች ይፋ አድርገዋል::

 የወላይታ ድቻ እግር ኳስ ቡድን በኢ-ፍትሃዊነትና ዳኝነት በደል ለሁለት ተከታታይ አመታት ካጣቸው የቻምፒዮናነት ክብር የ 2017ቱን  በደጋፊዎች እልህ አስጨራሽ ትግል ፍትህ ተረጋግጦለት ባለፈው አርብ በብዙ መቶ ሺህ የሚቆጠር የወላይታ ህዝብ ከመላው ወላይታና አቅራቢያ ካሉት ዞኖች ሶዶ ከተማ ላይ አደባባይ ወጥተው  ዋንጫውን በከፍተኛ ደስታ መረከቡ ይታወሳል:: 

 የሻምፒዮናነት ፍትህ በመገኘቱ ህዝብ ዘንድ ደስታው ከፍተኛ ቢሆንም የክለቡን ክብርና ጥቅም ከሚጎዳ ተግባር ጋር በተደጋጋሚ ስሙ ተያይዞ የሚነሳው የክለቡ አመራር እና የቦርድ አመራር  ለፍታችን አርብ ከሊቢያው አል ኢትሃድ ጋር ላለው ጨዋታ ቡድኑ በአግባቡ ትኩረት ሰጥተው እንዳላደረጃ ተጫዋቾቹን እንዳላሟላ አሰልጣኝ በጊዜ እንዳልቀጠረ አሰልጣኙ ከተቀጠረው በኋላም ለራሱ አዲስ አበባ ስልጠና እየተሳተፈ ክቡድኑ እንዳልተገናኘ በአጠቃላይ ቡድኑ ያለዝግጅት ወደ ሜዳ እየገባ እንደሆነ ደጋፊዎቹ በከፍተኛ ምሬት እያነሱ ይገኛል:: 

ይህ በእንዲህ እንዳለ ለአርቡ ጨዋታ ሜዳ ገብቶ መደገፍ የሚችለው አስቀድሞ የስታድየም መግቢያ ቲኬት የገዛ ሰው ብቻ እንደ ሆነ ከፌዴሬሽን የተገለፀ ሲሆን ከወላይታ ድቻ ክለብ በኩል የስታድየም መግቢያ ቲኬት ለማግኘት የክለቡ ደጋፊዎች ማህበር መታወቂያ መጠየቁ ግልጽነት የጎደለው የመታወቂያ ንግድ ማጧጧፍ ነው በሚል ከክለቡ ደጋፊዎች ቅሬታ አስነስቷል::
`,
    category: "news",
    featured: true,
  },
