                            ...
                            <div class="grid grid-cols-1">
                                ...
                                <div class="flex justify-between mb-4">
                                    ...
                                    <p class="text-slate-400 mb-0">
                                        <NuxtLink to="/forgot-password" class="text-slate-400">Forgot password ?
                                        </NuxtLink>
                                    </p>
                                </div>
                                ...
                                <div class="mb-4">
                                    <NuxtLink :to="[]"
                                        ...
                                        Login / Sign in</NuxtLink>
                                </div>

                                <div class="text-center">
                                    <span class="text-slate-400 me-2">Don't have an account ?</span>
                                    <NuxtLink to="/signup" class="text-black dark:text-white font-bold">Sign Up
                                    </NuxtLink>
                                </div>
                            </div>
                        </form>
